#!/bin/sh
#
# $FreeBSD: src/release/scripts/crypto-install.sh,v 1.1.2.2 2002/08/08 08:23:53 ru Exp $
# $DragonFly: src/release/scripts/Attic/crypto-install.sh,v 1.2 2003/06/17 04:27:21 dillon Exp $
#
