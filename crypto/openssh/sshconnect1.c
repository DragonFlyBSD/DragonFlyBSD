...
RCSID("$FreeBSD: src/crypto/openssh/sshconnect1.c,v 1.2.2.9 2003/02/03 17:31:08 des Exp $");
RCSID("$DragonFly: src/crypto/openssh/Attic/sshconnect1.c,v 1.2 2003/06/17 04:24:36 dillon Exp $");
