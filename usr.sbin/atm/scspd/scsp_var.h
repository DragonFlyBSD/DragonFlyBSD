 ...
 *	@(#) $DragonFly: src/usr.sbin/atm/scspd/scsp_var.h,v 1.3 2003/11/03 19:31:35 eirikn Exp $
 *
 */
...
/* scsp_if.c */
extern int	scsp_cfsm(Scsp_dcs *, int, Scsp_msg *,
			Scsp_if_msg *);
...
extern void		scsp_process_cache_rsp(Scsp_server *,
				Scsp_if_msg *);
extern int		scsp_propagate_csa( Scsp_dcs *,
				Scsp_csa *);
extern void		scsp_update_cache( Scsp_dcs *,
				Scsp_csa *);
