  ...
  case 3:
	...
	exit(0);
       ...
       clnt_stat=clnt_broadcast(BOOTPARAMPROG, BOOTPARAMVERS,
			       ...
			       (xdrproc_t)xdr_bp_whoami_arg, &whoami_arg,
			       (xdrproc_t)xdr_bp_whoami_res, &stat_whoami_res,
  ...
  case 4:
	...
	exit(0);
      ...
      clnt_stat=clnt_broadcast(BOOTPARAMPROG, BOOTPARAMVERS,
			       ...
			       (xdrproc_t)xdr_bp_getfile_arg, &getfile_arg,
			       (xdrproc_t)xdr_bp_getfile_res, &stat_getfile_res,
