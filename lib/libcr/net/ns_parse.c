 ...
 * SOFTWARE.
 *
 * $FreeBSD: src/lib/libc/net/ns_parse.c,v 1.3 1999/08/28 00:00:14 peter Exp $
 * $DragonFly: src/lib/libcr/net/Attic/ns_parse.c,v 1.2 2003/06/17 04:26:44 dillon Exp $
 */
