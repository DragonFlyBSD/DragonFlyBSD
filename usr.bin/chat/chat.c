...
static void fatal(int code, const char *fmt, ...) __dead2;
static SIGTYPE sigalrm(int signo);
static SIGTYPE sigint(int signo) __dead2;
static SIGTYPE sigterm(int signo) __dead2;
static SIGTYPE sighup(int signo) __dead2;
static void init(void);
static void set_tty_parameters(void);
static void echo_stderr(int);
static void break_sequence(void);
static void terminate(int status) __dead2;
