/* $FreeBSD: src/gnu/usr.bin/patch/util.h,v 1.7.2.1 2002/04/30 20:40:02 gad Exp $
/* $DragonFly: src/gnu/usr.bin/patch/Attic/util.h,v 1.2 2003/06/17 04:25:47 dillon Exp $
 *
 * $Log: util.h,v $
