...
/*
 * $FreeBSD: src/gnu/usr.bin/as/flo-const.c,v 1.5 1999/08/27 23:34:14 peter Exp $
 * $DragonFly: src/gnu/usr.bin/as/Attic/flo-const.c,v 1.2 2003/06/17 04:25:44 dillon Exp $
 */
#include "flonum.h"
