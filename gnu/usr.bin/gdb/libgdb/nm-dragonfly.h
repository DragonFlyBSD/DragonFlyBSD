/* $DragonFly: src/gnu/usr.bin/gdb/libgdb/Attic/nm-dragonfly.h,v 1.1 2007/02/26 13:14:04 corecode Exp $ */
...
#ifndef NM_DRAGONFLY_H
#define NM_DRAGONFLY_H
