/* Definitions for AMD x86-64 running FreeBSD with ELF format
   ...
   Modified for DragonFly by Matthew Dillon <dillon@backplane.com>
 ...
 * $DragonFly: src/gnu/usr.bin/cc3/config/i386/Attic/dragonfly64.h,v 1.1 2004/02/02 23:35:11 dillon Exp $
 */
