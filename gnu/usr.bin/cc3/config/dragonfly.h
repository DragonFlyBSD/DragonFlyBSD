...
/*
 * $FreeBSD: src/contrib/gcc/config/freebsd.h,v 1.38 2003/07/11 05:08:01 kan Exp $
 * $DragonFly: src/gnu/usr.bin/cc3/config/Attic/dragonfly.h,v 1.1 2004/02/02 23:35:11 dillon Exp $
 */
