 ...
 *
 * $FreeBSD: src/gnu/usr.bin/gzip/util.c,v 1.8 1999/08/27 23:35:54 peter Exp $
 * $DragonFly: src/gnu/usr.bin/gzip/Attic/util.c,v 1.2 2003/06/17 04:25:46 dillon Exp $
 */
