...
/*
 * $FreeBSD: src/gnu/usr.bin/rcs/lib/rcsfcmp.c,v 1.7 1999/08/27 23:36:45 peter Exp $
 * $DragonFly: src/gnu/usr.bin/rcs/lib/rcsfcmp.c,v 1.2 2003/06/17 04:25:47 dillon Exp $
 *
...
libId(fcmpId, "$DragonFly: src/gnu/usr.bin/rcs/lib/rcsfcmp.c,v 1.2 2003/06/17 04:25:47 dillon Exp $")
