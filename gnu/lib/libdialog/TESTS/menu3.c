 ...
 * its use.
 *
 * $FreeBSD: src/gnu/lib/libdialog/TESTS/menu3.c,v 1.9 2000/01/10 11:52:07 phantom Exp $
 * $DragonFly: src/gnu/lib/libdialog/TESTS/menu3.c,v 1.2 2003/06/17 04:25:44 dillon Exp $
 */
