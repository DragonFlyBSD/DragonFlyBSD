 ...
 * its use.
 *
 * $FreeBSD: src/gnu/lib/libdialog/TESTS/input2.c,v 1.5 2000/01/10 11:52:05 phantom Exp $
 * $DragonFly: src/gnu/lib/libdialog/TESTS/input2.c,v 1.2 2003/06/17 04:25:44 dillon Exp $
 */
