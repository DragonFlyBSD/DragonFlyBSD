 ...
 * its use.
 *
 * $FreeBSD: src/gnu/lib/libdialog/TESTS/radio3.c,v 1.7 2000/01/10 11:52:09 phantom Exp $
 * $DragonFly: src/gnu/lib/libdialog/TESTS/radio3.c,v 1.2 2003/06/17 04:25:44 dillon Exp $
 */
