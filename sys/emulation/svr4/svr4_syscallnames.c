 ...
 * $FreeBSD: src/sys/svr4/svr4_syscallnames.c,v 1.5.2.3 2001/10/05 07:38:44 peter Exp $
 * $DragonFly: src/sys/emulation/svr4/Attic/svr4_syscallnames.c,v 1.2 2003/06/17 04:28:57 dillon Exp $
