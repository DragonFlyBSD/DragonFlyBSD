 ...
 * $DragonFly: src/sys/emulation/linux/i386/linux_proto.h,v 1.7 2003/08/07 21:17:18 dillon Exp $
...
int	linux_fork __P((struct linux_fork_args *));
int	linux_open __P((struct linux_open_args *));
int	linux_waitpid __P((struct linux_waitpid_args *));
int	linux_creat __P((struct linux_creat_args *));
int	linux_link __P((struct linux_link_args *));
int	linux_unlink __P((struct linux_unlink_args *));
int	linux_execve __P((struct linux_execve_args *));
int	linux_chdir __P((struct linux_chdir_args *));
int	linux_time __P((struct linux_time_args *));
int	linux_mknod __P((struct linux_mknod_args *));
int	linux_chmod __P((struct linux_chmod_args *));
int	linux_lchown16 __P((struct linux_lchown16_args *));
int	linux_stat __P((struct linux_stat_args *));
int	linux_lseek __P((struct linux_lseek_args *));
int	linux_getpid __P((struct linux_getpid_args *));
int	linux_mount __P((struct linux_mount_args *));
int	linux_oldumount __P((struct linux_oldumount_args *));
int	linux_setuid16 __P((struct linux_setuid16_args *));
int	linux_getuid16 __P((struct linux_getuid16_args *));
int	linux_stime __P((struct linux_stime_args *));
int	linux_ptrace __P((struct linux_ptrace_args *));
int	linux_alarm __P((struct linux_alarm_args *));
int	linux_fstat __P((struct linux_fstat_args *));
int	linux_pause __P((struct linux_pause_args *));
int	linux_utime __P((struct linux_utime_args *));
int	linux_access __P((struct linux_access_args *));
int	linux_nice __P((struct linux_nice_args *));
int	linux_kill __P((struct linux_kill_args *));
int	linux_rename __P((struct linux_rename_args *));
int	linux_mkdir __P((struct linux_mkdir_args *));
int	linux_rmdir __P((struct linux_rmdir_args *));
int	linux_pipe __P((struct linux_pipe_args *));
int	linux_times __P((struct linux_times_args *));
int	linux_brk __P((struct linux_brk_args *));
int	linux_setgid16 __P((struct linux_setgid16_args *));
int	linux_getgid16 __P((struct linux_getgid16_args *));
int	linux_signal __P((struct linux_signal_args *));
int	linux_geteuid16 __P((struct linux_geteuid16_args *));
int	linux_getegid16 __P((struct linux_getegid16_args *));
int	linux_umount __P((struct linux_umount_args *));
int	linux_ioctl __P((struct linux_ioctl_args *));
int	linux_fcntl __P((struct linux_fcntl_args *));
int	linux_olduname __P((struct linux_olduname_args *));
int	linux_ustat __P((struct linux_ustat_args *));
int	linux_sigaction __P((struct linux_sigaction_args *));
int	linux_sgetmask __P((struct linux_sgetmask_args *));
int	linux_ssetmask __P((struct linux_ssetmask_args *));
int	linux_setreuid16 __P((struct linux_setreuid16_args *));
...
int	linux_socketcall __P((struct linux_socketcall_args *));
int	linux_syslog __P((struct linux_syslog_args *));
int	linux_setitimer __P((struct linux_setitimer_args *));
int	linux_getitimer __P((struct linux_getitimer_args *));
int	linux_newstat __P((struct linux_newstat_args *));
int	linux_newlstat __P((struct linux_newlstat_args *));
int	linux_newfstat __P((struct linux_newfstat_args *));
int	linux_uname __P((struct linux_uname_args *));
int	linux_iopl __P((struct linux_iopl_args *));
int	linux_vhangup __P((struct linux_vhangup_args *));
int	linux_vm86old __P((struct linux_vm86old_args *));
int	linux_wait4 __P((struct linux_wait4_args *));
int	linux_swapoff __P((struct linux_swapoff_args *));
int	linux_sysinfo __P((struct linux_sysinfo_args *));
int	linux_ipc __P((struct linux_ipc_args *));
int	linux_sigreturn __P((struct linux_sigreturn_args *));
int	linux_clone __P((struct linux_clone_args *));
int	linux_newuname __P((struct linux_newuname_args *));
int	linux_modify_ldt __P((struct linux_modify_ldt_args *));
int	linux_adjtimex __P((struct linux_adjtimex_args *));
int	linux_sigprocmask __P((struct linux_sigprocmask_args *));
int	linux_create_module __P((struct linux_create_module_args *));
int	linux_init_module __P((struct linux_init_module_args *));
int	linux_delete_module __P((struct linux_delete_module_args *));
int	linux_get_kernel_syms __P((struct linux_get_kernel_syms_args *));
int	linux_quotactl __P((struct linux_quotactl_args *));
int	linux_bdflush __P((struct linux_bdflush_args *));
int	linux_sysfs __P((struct linux_sysfs_args *));
int	linux_personality __P((struct linux_personality_args *));
int	linux_setfsuid16 __P((struct linux_setfsuid16_args *));
int	linux_setfsgid16 __P((struct linux_setfsgid16_args *));
int	linux_llseek __P((struct linux_llseek_args *));
int	linux_getdents __P((struct linux_getdents_args *));
int	linux_select __P((struct linux_select_args *));
int	linux_msync __P((struct linux_msync_args *));
int	linux_getsid __P((struct linux_getsid_args *));
int	linux_fdatasync __P((struct linux_fdatasync_args *));
int	linux_sysctl __P((struct linux_sysctl_args *));
int	linux_sched_setscheduler __P((struct linux_sched_setscheduler_args *));
int	linux_sched_getscheduler __P((struct linux_sched_getscheduler_args *));
int	linux_sched_get_priority_max __P((struct linux_sched_get_priority_max_args *));
int	linux_sched_get_priority_min __P((struct linux_sched_get_priority_min_args *));
int	linux_mremap __P((struct linux_mremap_args *));
int	linux_setresuid16 __P((struct linux_setresuid16_args *));
int	linux_getresuid16 __P((struct linux_getresuid16_args *));
int	linux_vm86 __P((struct linux_vm86_args *));
int	linux_query_module __P((struct linux_query_module_args *));
int	linux_nfsservctl __P((struct linux_nfsservctl_args *));
int	linux_setresgid16 __P((struct linux_setresgid16_args *));
int	linux_getresgid16 __P((struct linux_getresgid16_args *));
int	linux_prctl __P((struct linux_prctl_args *));
int	linux_rt_sigreturn __P((struct linux_rt_sigreturn_args *));
int	linux_rt_sigaction __P((struct linux_rt_sigaction_args *));
int	linux_rt_sigprocmask __P((struct linux_rt_sigprocmask_args *));
int	linux_rt_sigpending __P((struct linux_rt_sigpending_args *));
int	linux_rt_sigtimedwait __P((struct linux_rt_sigtimedwait_args *));
int	linux_rt_sigqueueinfo __P((struct linux_rt_sigqueueinfo_args *));
int	linux_rt_sigsuspend __P((struct linux_rt_sigsuspend_args *));
int	linux_pread __P((struct linux_pread_args *));
int	linux_pwrite __P((struct linux_pwrite_args *));
int	linux_chown16 __P((struct linux_chown16_args *));
int	linux_getcwd __P((struct linux_getcwd_args *));
int	linux_capget __P((struct linux_capget_args *));
int	linux_capset __P((struct linux_capset_args *));
int	linux_sigaltstack __P((struct linux_sigaltstack_args *));
int	linux_sendfile __P((struct linux_sendfile_args *));
int	linux_vfork __P((struct linux_vfork_args *));
int	linux_getrlimit __P((struct linux_getrlimit_args *));
int	linux_mmap2 __P((struct linux_mmap2_args *));
int	linux_truncate64 __P((struct linux_truncate64_args *));
int	linux_ftruncate64 __P((struct linux_ftruncate64_args *));
int	linux_stat64 __P((struct linux_stat64_args *));
int	linux_lstat64 __P((struct linux_lstat64_args *));
int	linux_fstat64 __P((struct linux_fstat64_args *));
int	linux_lchown __P((struct linux_lchown_args *));
int	linux_getuid __P((struct linux_getuid_args *));
int	linux_getgid __P((struct linux_getgid_args *));
int	linux_getgroups __P((struct linux_getgroups_args *));
int	linux_setgroups __P((struct linux_setgroups_args *));
int	linux_chown __P((struct linux_chown_args *));
int	linux_setfsuid __P((struct linux_setfsuid_args *));
int	linux_setfsgid __P((struct linux_setfsgid_args *));
int	linux_pivot_root __P((struct linux_pivot_root_args *));
int	linux_mincore __P((struct linux_mincore_args *));
int	linux_madvise __P((struct linux_madvise_args *));
int	linux_getdents64 __P((struct linux_getdents64_args *));
int	linux_fcntl64 __P((struct linux_fcntl64_args *));
