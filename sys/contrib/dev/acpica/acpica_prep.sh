#!/bin/sh
# $FreeBSD: src/sys/contrib/dev/acpica/acpica_prep.sh,v 1.4.4.1 2003/08/22 20:46:09 jhb Exp $
# $DragonFly: src/sys/contrib/dev/acpica/Attic/acpica_prep.sh,v 1.1 2003/09/24 03:46:00 drhodus Exp $
#
# Unpack an ACPI CA drop and restructure it to fit the DragonFly layout
#
