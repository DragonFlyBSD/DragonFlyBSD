...
struct bfe_hw_stats {
	uint32_t tx_good_octets, tx_good_pkts, tx_octets;
	uint32_t tx_pkts, tx_broadcast_pkts, tx_multicast_pkts;
	uint32_t tx_len_64, tx_len_65_to_127, tx_len_128_to_255;
	uint32_t tx_len_256_to_511, tx_len_512_to_1023, tx_len_1024_to_max;
	uint32_t tx_jabber_pkts, tx_oversize_pkts, tx_fragment_pkts;
	uint32_t tx_underruns, tx_total_cols, tx_single_cols;
	uint32_t tx_multiple_cols, tx_excessive_cols, tx_late_cols;
	uint32_t tx_defered, tx_carrier_lost, tx_pause_pkts;
	uint32_t __pad1[8];

	uint32_t rx_good_octets, rx_good_pkts, rx_octets;
	uint32_t rx_pkts, rx_broadcast_pkts, rx_multicast_pkts;
	uint32_t rx_len_64, rx_len_65_to_127, rx_len_128_to_255;
	uint32_t rx_len_256_to_511, rx_len_512_to_1023, rx_len_1024_to_max;
	uint32_t rx_jabber_pkts, rx_oversize_pkts, rx_fragment_pkts;
	uint32_t rx_missed_pkts, rx_crc_align_errs, rx_undersize;
	uint32_t rx_crc_errs, rx_align_errs, rx_symbol_errs;
	uint32_t rx_pause_pkts, rx_nonpause_pkts;
};
