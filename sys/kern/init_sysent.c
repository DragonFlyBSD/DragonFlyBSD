 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.49 2007/01/08 03:33:41 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.46 2007/01/06 01:46:40 dillon Exp 
 */
