 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.51 2007/02/25 14:08:08 corecode Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.49 2007/02/25 14:07:13 corecode Exp 
 */
