 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.52 2007/03/01 01:48:51 corecode Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.50 2007/03/01 01:46:52 corecode Exp 
 */
