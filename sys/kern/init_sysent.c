 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.41 2006/06/13 08:12:03 dillon Exp $
...
struct sysent sysent[] = {
	...
	{ SYF_MPSAFE | AS(__pread_args), (sy_call_t *)sys___pread },	/* 173 = __pread */
	{ SYF_MPSAFE | AS(__pwrite_args), (sy_call_t *)sys___pwrite },	/* 174 = __pwrite */
	...
	{ SYF_MPSAFE | AS(__preadv_args), (sy_call_t *)sys___preadv },	/* 289 = __preadv */
	{ SYF_MPSAFE | AS(__pwritev_args), (sy_call_t *)sys___pwritev },	/* 290 = __pwritev */
