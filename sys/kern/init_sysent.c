 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.56 2007/04/22 00:59:25 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.53 2007/04/16 17:40:13 dillon Exp 
 */
