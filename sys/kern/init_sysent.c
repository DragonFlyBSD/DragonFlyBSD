 ...
 * $DragonFly: src/sys/kern/init_sysent.c,v 1.50 2007/01/08 21:41:56 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.47 2007/01/08 03:33:41 dillon Exp 
 */
