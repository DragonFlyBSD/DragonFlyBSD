 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.55 2007/04/16 17:40:16 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.52 2007/03/21 20:06:34 dillon Exp 
 */
...
struct	syslink_args {
	...
	int	fd;	char fd_[PAD_(int)];
	int	cmd;	char cmd_[PAD_(int)];
	void *	info;	char info_[PAD_(void *)];
	int	bytes;	char bytes_[PAD_(int)];
};
