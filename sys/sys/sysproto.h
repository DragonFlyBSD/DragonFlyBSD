 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.27 2005/02/21 21:40:58 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.19 2005/02/20 01:17:44 davidxu Exp 
 */
...
struct	sys_set_tls_area_args {
	...
	int	infosize;	char infosize_[PAD_(int)];
};
