 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.40 2006/06/07 03:02:11 dillon Exp $
...
int	sys_pread (struct pread_args *);
int	sys_pwrite (struct pwrite_args *);
...
int	sys_preadv (struct preadv_args *);
int	sys_pwritev (struct pwritev_args *);
