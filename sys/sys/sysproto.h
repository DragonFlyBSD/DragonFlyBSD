 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.42 2006/06/13 21:04:17 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.39 2006/06/13 08:12:03 dillon Exp 
 */
...
int	sys___pread (struct __pread_args *);
int	sys___pwrite (struct __pwrite_args *);
...
int	sys___preadv (struct __preadv_args *);
int	sys___pwritev (struct __pwritev_args *);
...
int	sys_sys_set_tls_area (struct sys_set_tls_area_args *);
int	sys_sys_get_tls_area (struct sys_get_tls_area_args *);
