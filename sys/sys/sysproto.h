 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.35 2005/11/16 02:24:33 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.27 2005/08/27 20:23:05 joerg Exp 
 */
...
int	dfbsd12_getdirentries (struct dfbsd12_getdirentries_args *);
int	dfbsd12_getdents (struct dfbsd12_getdents_args *);
...
int	usched_set (struct usched_set_args *);
