 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.2 2003/06/17 04:28:59 dillon Exp $
 * created from TurtleBSD: src/sys/kern/syscalls.master,v 1.1 2003/06/16 06:26:15 dillon Exp 
 */
...
int	osendfile __P((struct proc *, struct osendfile_args *));
