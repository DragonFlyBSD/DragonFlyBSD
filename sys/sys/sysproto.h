 ...
 * $DragonFly: src/sys/sys/sysproto.h,v 1.54 2007/03/21 20:06:36 dillon Exp $
 * created from DragonFly: src/sys/kern/syscalls.master,v 1.51 2007/03/12 21:07:42 corecode Exp 
 */
...
struct	syslink_args {
	...
	int	fd;	char fd_[PAD_(int)];
	int	flags;	char flags_[PAD_(int)];
	sysid_t	routenode;	char routenode_[PAD_(sysid_t)];
};
