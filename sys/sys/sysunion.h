 ...
 * $DragonFly: src/sys/sys/sysunion.h,v 1.35 2006/06/05 00:35:05 davidxu Exp $
...
#ifdef COMPAT_DF12
	struct	dfbsd12_getdirentries_args dfbsd12_getdirentries;
#endif
...
#ifdef COMPAT_DF12
	struct	dfbsd12_getdents_args dfbsd12_getdents;
#endif
	struct	lchmod_args lchmod;
	struct	lutimes_args lutimes;
	struct	preadv_args preadv;
	struct	pwritev_args pwritev;
