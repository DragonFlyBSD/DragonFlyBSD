 ...
 * $DragonFly: src/sys/sys/sysunion.h,v 1.39 2006/06/13 21:04:17 dillon Exp $
...
union sysunion {
	...
	struct	__pread_args __pread;
	struct	__pwrite_args __pwrite;
	...
	struct	__preadv_args __preadv;
	struct	__pwritev_args __pwritev;
