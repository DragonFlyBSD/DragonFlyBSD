/*	$FreeBSD: head/sys/dev/usb/wlan/if_rumvar.h 297171 2016-03-21 22:29:24Z avos $	*/
...
#define RUM_LOCK_DESTROY(sc)		lockuninit(&(sc)->sc_lock)

#define RUM_CMDQ_LOCK_INIT(sc) \
	lockinit(&(sc)->cmdq_lock, "cmdq lock", 0, LK_CANRECURSE)
#define RUM_CMDQ_LOCK(sc)		lockmgr(&(sc)->cmdq_lock, LK_EXCLUSIVE)
#define RUM_CMDQ_UNLOCK(sc)		lockmgr(&(sc)->cmdq_lock, LK_RELEASE)
#define RUM_CMDQ_LOCK_DESTROY(sc)	lockuninit(&(sc)->cmdq_lock)
