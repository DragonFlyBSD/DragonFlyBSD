 ...
 *
 * $FreeBSD: head/sys/dev/usb/net/if_urndis.c 261544 2014-02-06 10:47:47Z hselasky $
 */
...
#include <bus/u4b/net/if_urndisreg.h>
...
urndis_attach(device_t dev)
{
	...
	for (i = 0; i != 32; i++) {
		...
		error = usbd_transfer_setup(uaa->device,
		    ...
		    URNDIS_N_TRANSFER, sc, &sc->sc_lock);
