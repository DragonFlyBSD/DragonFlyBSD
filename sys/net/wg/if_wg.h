...
/* Maximum length of the peer description, including the terminating NUL. */
...
struct wg_peer_io {
	int			p_flags; /* WG_PEER_* */
	uint8_t			p_public[WG_KEY_SIZE];
	uint8_t			p_psk[WG_KEY_SIZE]; /* preshared key */
	uint16_t		p_pka; /* persistent keepalive */
	union {
