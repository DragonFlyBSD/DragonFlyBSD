 ...
 *
 * $FreeBSD: src/contrib/sendmail/src/headers.c,v 1.4.2.12 2003/10/30 22:31:44 gshapiro Exp $
 *
 * $DragonFly: src/contrib/sendmail/src/Attic/headers.c,v 1.4 2003/12/22 04:04:23 drhodus Exp $
 */
