...
system or user addresses, which allows I/O devices to operate entirely
independantly of the originating user process.
<P>
...
Multi-threaded devices would not necessarily compete for resources.  For
...
kernel-only threads.  Though we probably will not achieve this capability
