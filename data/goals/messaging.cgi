...
<P>
DragonFly will have a light weight port/messaging API to go along with its
light weight kernel threads.  The port/messaging API is very simple
...
number of reasons and it is in fact precisely the mp_sendMsg() function for
